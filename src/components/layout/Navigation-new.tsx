      ...
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <Link
              href="/contact"
              className="px-6 py-3 bg-gradient-gold-copper text-black font-bold rounded-lg hover:shadow-lg transition-all hover:scale-105"
            >
              Book Consultation
            </Link>
          </div>
          ...
          <div className="lg:hidden py-6 border-t border-[var(--primary)]/20">
            <div className="flex flex-col space-y-4">
              ...
              <Link
                href="/contact"
                onClick={() => setIsOpen(false)}
                className="inline-block text-center px-6 py-3 bg-gradient-gold-copper text-black font-bold rounded-lg"
              >
                Book Consultation
              </Link>
            </div>
